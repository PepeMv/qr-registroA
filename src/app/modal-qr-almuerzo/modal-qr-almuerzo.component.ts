...
@Component({
  selector: 'app-modal-qr-almuerzo',
  templateUrl: './modal-qr-almuerzo.component.html',
  styleUrls: ['./modal-qr-almuerzo.component.css']
})
export class ModalQrAlmuerzoComponent implements OnInit {
  ...
  myDate = this.datePipe.transform(new Date(), "yyyy-MM-dd HH:mm:ss a");
